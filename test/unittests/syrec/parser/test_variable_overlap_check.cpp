...
// or bitrange component. Future tests should also test the correct behaviour using syrec::Expresssions.
...
INSTANTIATE_TEST_SUITE_P(VariableAccessOverlapTests, ExpectingPotentiallyOverlappingVariableAccessesTestFixture,
    testing::ValuesIn({
       ...
       OverlapTestData("1DSignal_lAccess_ImplicitDimensionAccessWithBitrangeAccessUsingConstantIndices_rAccess_ImplicitDimensionAccessWithUnknownBitAccess",
        ...
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithNoBitrangeAccess_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"})),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithNoBitrangeAccess_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"})),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), 2U)),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithNoBitrangeAccess_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"})),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(5U, 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithNoBitrangeAccess_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"})),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithNoBitrangeAccess_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"})),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithNoBitrangeAccess_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"})),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 2U),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 3U),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 3U),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 2U),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 2U),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 3U),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 1U),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 2U),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithWithBitAccessUsingNonConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 2U)),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(5U, 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), 2U)),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(5U, 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$i"),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithWithBitrangeAccessUsingNonConstantStartIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 2U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 3U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 2U)),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 6U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(5U, 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 1U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 3U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 2U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 2U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 3U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), 2U)),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 3U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(5U, 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 3U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 3U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", 2U)),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithWithBitrangeAccessUsingNonConstantEndIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(2U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(3U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 2U)),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(6U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(5U, 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(1U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(3U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(2U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(2U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(3U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), 2U)),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(1U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(5U, 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(3U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(3U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(2U, "$i")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithWithBitrangeAccessUsingNonConstantIndices_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitAccessUsingConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), 2U)),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(5U, 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$s", "$i"))),

        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingNonConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), "$s")),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitAccessUsingConstantIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), 2U)),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(5U, 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantStartIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", 2U))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantEndIndex",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair(2U, "$s"))),
        OverlapTestData("NDSignal_lAccess_AccessOnFirstDimensionUsingConstantIndexAndSecondDimensionUsingNonConstantIndexWithBitrangeAccessUsingNonConstantIndices_rAccess_UsingOnlyConstantIndicesInDimensionAccessWithBitrangeAccessUsingNonConstantIndices",
            VariableDefinition(DEFAULT_VARIABLE_IDENTIFIER, std::vector({2U, 4U}), DEFAULT_VARIABLE_BITWIDTH),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, "$i"}), std::make_pair("$i", "$k")),
            VariableAccessDefinition(std::vector<VariableAccessDefinition::IndexDataVariant>({0U, 2U}), std::make_pair("$s", "$i")))
