...
namespace {
    ...
    constexpr auto PATH_TO_ERROR_CASES = "./unittests/syrec/parser/data/error";
    ...
    constexpr auto PRODUCTION_SKIP_STATEMENT_FILE_NAME   = "test_production_skipStatement.json";
    constexpr auto PRODUCTION_STATEMENT_LIST_FILE_NAME   = "test_production_statementList.json";
    ...
    constexpr auto PRODUCTION_EXPRESSION_FILE_NAME        = "test_production_expression.json";
    ...
    class SyrecParserErrorCasesTestFixture: public SyrecParserBaseTestsFixture {
    public:
        void SetUp() override {
            return SyrecParserBaseTestsFixture::SetUp();
        }
...
TEST_P(SyrecParserErrorCasesTestFixture, SyrecParserErrorCases) {
    ASSERT_NO_FATAL_FAILURE(performTestExecution());
}
...
INSTANTIATE_TEST_SUITE_P(
        ...
        testing::ValuesIn(loadTestCaseNamesFromFiles({
            ...
            FilenameAndTestNamePrefix({PATH_TO_SUCCESS_CASES, PRODUCTION_SKIP_STATEMENT_FILE_NAME, "production_skipStatement"}),
            FilenameAndTestNamePrefix({PATH_TO_SUCCESS_CASES, PRODUCTION_STATEMENT_LIST_FILE_NAME, "production_statementList"}),
            ...
            FilenameAndTestNamePrefix({PATH_TO_SUCCESS_CASES, PRODUCTION_EXPRESSION_FILE_NAME, "production_expression"}),
...
INSTANTIATE_TEST_SUITE_P(
        ...
        SyrecParserErrorCasesTestFixture,
        testing::ValuesIn(loadTestCaseNamesFromFiles({
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_PROGRAM_FILE_NAME, "production_program"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_MODULE_FILE_NAME, "production_module"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_ASSIGN_STATEMENT_FILE_NAME, "production_assignStatement"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_CALL_STATEMENT_FILE_NAME, "production_callStatement"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_UNCALL_STATEMENT_FILE_NAME, "production_uncallStatement"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_FOR_STATEMENT_FILE_NAME, "production_forStatement"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_IF_STATEMENT_FILE_NAME, "production_ifStatement"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_SKIP_STATEMENT_FILE_NAME, "production_skipStatement"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_STATEMENT_LIST_FILE_NAME, "production_statementList"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_SWAP_STATEMENT_FILE_NAME, "production_swapStatement"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_UNARY_STATEMENT_FILE_NAME, "production_unaryStatement"}),

            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_EXPRESSION_FILE_NAME, "production_expression"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_BINARY_EXPRESSION_FILE_NAME, "production_binaryExpression"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_SHIFT_EXPRESSION_FILE_NAME, "production_shiftExpression"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_UNARY_EXPRESSION_FILE_NAME, "production_unaryExpression"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_SIGNAL_FILE_NAME, "production_signal"}),
            FilenameAndTestNamePrefix({PATH_TO_ERROR_CASES, PRODUCTION_NUMBER_FILE_NAME, "production_number"})
        })),
        [](const testing::TestParamInfo<SyrecParserBaseTestsFixture::ParamType>& info) { return info.param.testCaseName; }
    );