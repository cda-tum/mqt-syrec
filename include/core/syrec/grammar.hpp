...
BOOST_FUSION_ADAPT_STRUCT(
  ...
  (std::string, name)
  (std::vector<revkit::syrec::ast_expression>, indexes)
  (revkit::syrec::ast_range, range)
)

BOOST_FUSION_ADAPT_STRUCT(
  revkit::syrec::ast_number_expression,
  (revkit::syrec::ast_number, operand1)
  (std::string, op)
  (revkit::syrec::ast_number, operand2)
)

BOOST_FUSION_ADAPT_STRUCT(
  revkit::syrec::ast_binary_expression,
  (revkit::syrec::ast_expression, operand1)
  (std::string, op)
  (revkit::syrec::ast_expression, operand2)
)

BOOST_FUSION_ADAPT_STRUCT(
  revkit::syrec::ast_unary_expression,
  (std::string, op)
  (revkit::syrec::ast_expression, operand)
)
...
BOOST_FUSION_ADAPT_STRUCT(
  ...
  (revkit::syrec::ast_expression, condition)
  (std::vector<revkit::syrec::ast_statement>, if_statement)
  (std::vector<revkit::syrec::ast_statement>, else_statement)
  (revkit::syrec::ast_expression, fi_condition)
)

BOOST_FUSION_ADAPT_STRUCT(
  revkit::syrec::ast_for_statement,
  (revkit::syrec::ast_for_statement::from_t, from)
  (revkit::syrec::ast_number, to)
  (revkit::syrec::ast_for_statement::step_t, step)
  (std::vector<revkit::syrec::ast_statement>, do_statement)
)
...
namespace revkit
{
  namespace syrec
  {
    ...
    {
      explicit syrec_skip_parser() : syrec_skip_parser::base_type( base_rule )
      {
        using qi::char_;
        using qi::eol;
        using qi::lit;
    ...
    {
      explicit syrec_parser() : syrec_parser::base_type( program_rule, "syrec" )
      {
        using qi::_1;
        using qi::_val;
        using qi::char_;
