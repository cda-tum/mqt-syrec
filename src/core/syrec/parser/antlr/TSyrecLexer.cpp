...
::antlr4::internal::OnceFlag tsyreclexerLexerOnceFlag;
#if ANTLR4_USE_THREAD_LOCAL_CACHE
static thread_local
#endif
std::unique_ptr<TSyrecLexerStaticData> tsyreclexerLexerStaticData = nullptr;

void tsyreclexerLexerInitialize() {
#if ANTLR4_USE_THREAD_LOCAL_CACHE
  if (tsyreclexerLexerStaticData != nullptr) {
    return;
  }
#else
  assert(tsyreclexerLexerStaticData == nullptr);
#endif
  ...
  tsyreclexerLexerStaticData = std::move(staticData);
}

}

TSyrecLexer::TSyrecLexer(CharStream *input) : Lexer(input) {
  TSyrecLexer::initialize();
  _interpreter = new atn::LexerATNSimulator(this, *tsyreclexerLexerStaticData->atn, tsyreclexerLexerStaticData->decisionToDFA, tsyreclexerLexerStaticData->sharedContextCache);
}
...
const std::vector<std::string>& TSyrecLexer::getRuleNames() const {
  return tsyreclexerLexerStaticData->ruleNames;
}

const std::vector<std::string>& TSyrecLexer::getChannelNames() const {
  return tsyreclexerLexerStaticData->channelNames;
}

const std::vector<std::string>& TSyrecLexer::getModeNames() const {
  return tsyreclexerLexerStaticData->modeNames;
}

const dfa::Vocabulary& TSyrecLexer::getVocabulary() const {
  return tsyreclexerLexerStaticData->vocabulary;
}

antlr4::atn::SerializedATNView TSyrecLexer::getSerializedATN() const {
  return tsyreclexerLexerStaticData->serializedATN;
}

const atn::ATN& TSyrecLexer::getATN() const {
  return *tsyreclexerLexerStaticData->atn;
}
...
#if ANTLR4_USE_THREAD_LOCAL_CACHE
  tsyreclexerLexerInitialize();
#else
  ::antlr4::internal::call_once(tsyreclexerLexerOnceFlag, tsyreclexerLexerInitialize);
#endif
}
