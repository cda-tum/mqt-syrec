...
int main(int argc, char** argv) {
    ...
    opts.add_options()("filename", boost::program_options::value<std::string>(&filename), "SyReC-Programm-Datei")("crement_merge_line_count", boost::program_options::value<unsigned>(&crement_merge_line_count)->default_value(4u), "Crement Merge Line Count")("if_realization", boost::program_options::value<unsigned>(&if_realization)->default_value(syrec_synthesis_if_realization_controlled), "Type of IF realization\n  0: controlled\n  1: duplication")("efficient_controls", boost::program_options::value<bool>(&efficient_controls)->default_value(true), "use optimization for efficient controlled cascades\n  true: yes\n  false: no")("modules_hierarchy", boost::program_options::value<bool>(&modules_hierarchy)->default_value(false), "create circuit modules for syrec modules")("print_circuit", boost::program_options::value<bool>(&print_circ)->default_value(true), "print resulting circuit");
